        ...
        <header>
            ...
            <div class="login_form">
                <div class="login_member">
                    ...
                    <div class="sns_login">
                        <a href="#"><img src="img/btnG_완성형.png"></a>
                        <a href="#"><img src="img/kakao_login_large_narrow.png"></a>
                    </div>
                </div>
                <div class="login_staff_only">
                    ...
                    <form action="">
                        <div class="login_container">
                            <input class="form_lock" type="text" placeholder="아이디를 입력하세요">
                            <input class="form_lock" type="password" placeholder="비밀번호를 입력하세요">
                            <input class="login_btn" type="submit" value="로그인">
                        </div>
                    </form>
                    <p style="font-size:0.8em; text-decoration: underline; color: #ff0000;">*부정 사용할 경우 관련 법에 따라 처벌받을 수 있습니다.</p>
                    <input class="locker" type="checkbox"> 확인했습니다.
                </div>
                <button class="exit_btn" id="exitButton">닫기</button>
            </div>
        </header>
        `;
